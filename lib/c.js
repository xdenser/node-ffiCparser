  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_DeclarationSpecifiers() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, head, type, tail) { var a=head; a=a.concat(type); a=a.concat(tail); return a; })(pos0, result0[0], result0[1], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_InitDeclaratorList() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, head, tail) { return [head].concat(tail);})(pos0, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_InitDeclarator() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            result1 = (function(offset, init) {return init;})(pos2, result1[1]);
          }
          if (result1 === null) {
            pos = pos2;
          }
        ...
        if (result0 !== null) {
          result0 = (function(offset, dec, init) { if(init) dec.initializer = init; return dec;})(pos0, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_SpecifierQualifierList() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, head, type, tail) { return head.concat(type,tail);})(pos0, result0[0], result0[1], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_TypedefName() {
        ...
        result0 = parse_Identifier();
        if (result0 !== null) {
          result0 = (function(offset, id) { return {type:'userTypesSpecifier', value: id};})(pos0, result0);
        }
        if (result0 === null) {
          pos = pos0;
        }
